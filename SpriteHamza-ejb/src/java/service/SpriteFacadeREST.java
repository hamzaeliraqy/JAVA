...
import cst8218.elir0002.entity.Sprite;
 ...
 *
 * @author hamza
 * Responsible for adding data to database using persistence
 */
@Stateless
@DeclareRoles ({"RestAdmin","Regular"}) 
@RolesAllowed ("RestAdmin")
@Path("cst8218.elir0002.entity.sprite")
