...
public class Student {
	...
	// asks how many bonuses and limit the bonuses to 75 which is 15*5 
		...
		// gets all the marks and calculate gpa if gpa is above 4 it will output as 4 and if any mark is 0 the gpa will be 0
		...
		public  void displayStudentDetails() {
			...
			System.out.println(studNumber + "                  " + firstName + " " + lastName + "            " + df.format(totalMarks) + "      " + df.format(gpa) + "          " + letGrade);
		}
